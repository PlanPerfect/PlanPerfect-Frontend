 ...
 */
function PreviewSelections({ preferences, analysisResults, selectedStyles, uploadedImageUrl, onStylesChange, onBack }) {
	...
	return (
		<Box w="100%" maxW="1200px" mx="auto" p={8}>
			...
			<Flex direction="column" gap={6}>
				...
				<Box border="2px solid #D4AF37" borderRadius="12px" p={6} bg="white" boxShadow="md">
					...
					<Flex direction="column" gap={3} align="center">
						...
						<Flex align="center" gap={2}>
							...
							<Text color="gray.600">{preferences?.budgetMin && preferences?.budgetMax ? `SGD $${(preferences.budgetMin / 1000).toFixed(0)}k - $${(preferences.budgetMax / 1000).toFixed(0)}k` : "Not specified"}</Text>
						</Flex>
					</Flex>
				</Box>
				...
				{/* Call to Action Card */}
				<Box border="2px solid #4299E1" borderRadius="12px" p={6} bg="#EBF8FF" boxShadow="md">
